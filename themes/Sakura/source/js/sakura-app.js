    ...
    switch (type) {
        case 1:
            if (ele.src.includes('https://cn.gravatar.com/avatar')) {
                ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/gravatar.jpg')
            } else {
                ele.src = 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/default_avatar.jpg'
            }
            break
        case 2:
            ele.src = 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/default_gavatar.jpg'
            break
        case 3:

            ele.src = 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/image-404.png'
            break
        default:
            ele.src = 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/image-404.png'
    }
...
function checkBgImgCookie() {
    ...
    if (bgurl != '') {
        if (bgurl == 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/themebg/little-monster.png') {
...
$(document).ready(function() {
        function changeBG(tagid, url) {
            $('.skin-menu ' + tagid).click(function() {
                ...
                mashiro_global.variables.isNight = false
                // $('#night-mode-cover').css('visibility', 'hidden')
                $('.bg-canvas').css('background', 'url(' + url + ') center center / cover no-repeat')
                // $('.blank').css('background-color', 'rgba(255,255,255,1)')
                // $('.pattern-center').removeClass('pattern-center').addClass('pattern-center-sakura')
                // $('.headertop-bar').removeClass('headertop-bar').addClass('headertop-bar-sakura')
                // $('#banner_wave_1').addClass('banner_wave_hide_fit_skin')
        ...
        changeBG('#sakura-bg', 'https://yingserver.cn/open/acgimg/acgurl.php')
        $('.skin-menu #white-bg').click(function() {
            mashiro_global.variables.skinSecter = false
            mashiro_global.variables.isNight = false
            $('.bg-canvas').css('background', 'url(https://cdn.jsdelivr.net/gh/dummerchen/My_Image_Bed01@master/img/20201221160708.jpg) center center / cover no-repeat')
            closeSkinMenu()
        ...
        $('.skin-menu #dark-bg').click(function() {
            mashiro_global.variables.skinSecter = true
            mashiro_global.variables.isNight = true
            $('.bg-canvas').css('background', 'url(https://cdn.jsdelivr.net/gh/dummerchen/cdn/img/other/starry_sky.png) center center / cover no-repeat')
            closeSkinMenu()
        })
    ...
    Siren = {
        ...
        SWP: function(){
            ...
            if(myurl.includes(localurl))
            {
                ...
                $('.swiper-wrapper').append('<div class="swiper-slide swiper-lazy" data-background="path/to/picture-3.jpg style="background: url(\''+ bg[bgindex] +'\') center center / cover no-repeat;overflow:hidden;"></div>')
                ...
                　　lazyLoadingInPrevNextAmount : 2,   //加载下一个slide
